...
public class Order {
    public static boolean placeOrder(Customer customer, Product product) // create a function to place order
    {
    ...
    public static int placeMultipleOrder(Customer customer, ObservableList<Product> productList) // create a function to place order
    {
        String groupOrderId = "select max(group_order_id) +1 id from orders";
        DbConnection dbConnection = new DbConnection();
        try
